...
[`@aws-sdk/client-compute-optimizer`](https://www.npmjs.com/package/@aws-sdk/client-compute-optimizer/v/3.1047.0).
...
- @aws-sdk/client-compute-optimizer v3.1047.0 - [https://cloud-sdk-builds.github.io/?sdk=client-compute-optimizer&version=3.1047.0](https://cloud-sdk-builds.github.io/?sdk=client-compute-optimizer&version=3.1047.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer@3.1047.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x8TRh3y8KEzwUtnw/oo3Oa8gDFDVvUPUKU+vbmRo4hJIsRG1tQZ/beitfPb6+KLh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-compute-optimizer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer@3.1047.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer@3.1047.0/index.min.mjs": "sha384-x8TRh3y8KEzwUtnw/oo3Oa8gDFDVvUPUKU+vbmRo4hJIsRG1tQZ/beitfPb6+KLh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-compute-optimizer/blob/refs/tags/3.1047.0/LICENSE
```
